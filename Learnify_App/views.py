...
def home(request):
    ...
    return render(request, 'Learnify/home.html',{'courses':courses,'instructors':instructors})
...
def student_home(request):
    courses = Course.objects.filter(status=True)
    instructors = Instructor.objects.all()
    return render(request, 'student/student_home.html',{'courses':courses,'instructors':instructors})
